...
import { formatPercentage, lazyAccessor, SPACING, weakMemoize } from "../../../helpers"
		...
		<Module name="volume" spacing={SPACING.NONE}>
			<menubutton>
				<box spacing={SPACING.TIGHT}>
					...
					<label cssName="value" cssClasses={["font-mono", "font-normal"]} label={volume} />
				</box>
				<popover hasArrow={false}>
					<box spacing={SPACING.NORMAL} orientation={Gtk.Orientation.VERTICAL}>
						<box>
							<button
								cssClasses={["p-1", "m-0", "rounded-full", "min-width-8", "min-height-8"]}
								onClicked={() => defaultSpeaker.set_mute(!defaultSpeaker.get_mute())}
							>
