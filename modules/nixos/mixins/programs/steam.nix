...
mkMixinModule "steam" {
  options.mixins.programs.steam.resolution = lib.mkOption {
    type = lib.types.str;
    default = "1920x1080";
    example = "2560x1440";
    description = ''
      Output resolution gamescope is launched at.
    '';
  };
  ...
  programs = {
    ...
    gamescope = {
      ...
      args =
        let
          _resolution = lib.splitString "x" config.mixins.programs.steam.resolution;
        in
        [
