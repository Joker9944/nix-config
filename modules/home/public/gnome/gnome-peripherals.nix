  ...
  config = {
    dconf.settings = {
      "org/gnome/desktop/peripherals/mouse" = {
        ...
        speed = flake.lib.modules.nonNull cfg.mouse.pointerSpeed;
      ...
      "org/gnome/desktop/peripherals/touchpad" = {
        ...
        disable-while-typing = flake.lib.modules.nonNull cfg.touchpad.disableTouchpadWhileTyping;
        speed = flake.lib.modules.nonNull cfg.touchpad.pointerSpeed;
        ...
        tap-to-click = flake.lib.modules.nonNull cfg.touchpad.tapToClick;
