...
* [custom-lib](custom-lib.md) — Three directory-loaded libs: `lib/` for module-system helpers (`custom.lib`), the `apps/util-lib` flake for general-purpose ones (`libUtil`), and `apps/nix-schemes` for colour schemes (`libSchemes`).
