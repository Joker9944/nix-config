...
* [shortcut-scheme](shortcut-scheme.md) — Which modifier belongs to which layer — Super to the WM, Ctrl to apps, Ctrl+Shift to the terminal — and the composition rules every new bind must pass.
