...
* [shortcut-standards](shortcut-standards.md) — what each platform standard assigns to which modifier: the two-layer consensus, Shift as the variant, and why terminals live on Ctrl+Shift.
