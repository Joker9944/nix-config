...
Home-manager runs [standalone](/decisions/standalone-home-manager.md), not as a NixOS module — but both trees are constructed from a paired host record in `flake.nix` and share `pkgs` and overlays.
